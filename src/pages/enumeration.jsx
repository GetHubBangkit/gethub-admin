...
import FormContent from "../modules/enumeration/form";
import _ from "underscore";

export default function Enumeration() {
	const { isUserLoading } = useUser({ redirectTo: "/login" });

	const API_ENDPOINT = process.env.NEXT_PUBLIC_API_ENDPOINT + "/enumerations";
	const CRUD_ENDPOINT = process.env.NEXT_PUBLIC_API_ENDPOINT + "/enumeration";
	const INITIAL_FORM = {
		id: "",
		key: "",
		value: "",
	...
	return (
		<Layout title="Enumeration" breadcrumbs={["Enumeration"]} active="/enumeration">
			<Container>
